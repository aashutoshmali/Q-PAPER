<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SubjectMaster.aspx.vb" Inherits="SubjectMaster" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <tr>
                        <td align="center" style="background-color: #507cd1; border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; height: 20px;">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="11pt"
                                Text="Subject Master" ForeColor="White"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnlast" runat="server"  TabIndex="23" Text=">>|" OnClick="btnlast_Click"
                                            Width="32px" /></td>
                                    <td style="width: 3px">
                                        <asp:Button ID="btnView" runat="server" OnClick="btnView_Click" Text="Back" Width="58px" /></td>
                                </tr>
                            </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Subject Name"
                                            Width="120px"></asp:Label></td>
                                    <td>
                                        <asp:TextBox ID="txtsubject" runat="server" Font-Names="Verdana" Font-Size="10pt"
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Subject Code"
                                            Width="120px"></asp:Label></td>
                                    <td>
                                        <asp:TextBox ID="txtcode" runat="server" Font-Names="Verdana" Font-Size="10pt" Height="16px"
                                            MaxLength="12" TabIndex="3" Width="160px"></asp:TextBox></td>
                                    <td style="height: 30px">
                                    </td>
                                    <td>
                                    </td>
                    ...
                    <tr>
                        <td align="center" bgcolor="#b0c4de" style="width: 850px; height: 18px; background-color: #507cd1;">
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="11pt"
                                ForeColor="White" Text="Subject Master"></asp:Label></td>
                    </tr>
                    <tr>
                            ...
                            <asp:GridView ID="gvFind" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Subject" SortExpression="Subject" >
                                      ...
                                      <asp:TemplateField HeaderText="SubjectCode" SortExpression="SubjectCode" >
                                        <ItemTemplate>
                                            <asp:Label ID="SubjectCode" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SubjectCode")  %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
